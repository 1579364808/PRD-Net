...
#   ./train.sh mosi --gpu 0 --base.lr=0.0001
# ============================================================
...
DATASET_CONFIGS["sims"]="configs/sims.yaml"
DATASET_CONFIGS["mosi"]="configs/mosi.yaml"
DATASET_CONFIGS["mosei"]="configs/mosei.yaml"
